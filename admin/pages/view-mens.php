        ...
        <table class="table">
            ...
            <?php while($product = $products->fetch_assoc()){ ?>
                <tr>
                    ...
                    <td><?= $product['price'] ?></td>
                    <td>
                        <a type="button" class="btn btn-primary" href='edit-mens.php?id=<?= $product['id'] ?>'>Edit</a>
                        <a type="button" class="btn btn-secondary" href='view-mens.php?delete-id=<?= $product['id'] ?>'>Delete</a>
                    </td>
                </tr>
