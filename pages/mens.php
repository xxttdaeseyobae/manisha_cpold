...
include_once ($_SERVER['DOCUMENT_ROOT']."/hamroluga/admin/classes/mens.php");
                    ...
                    <div class="card" >
                        ...
                        <div class="card-footer">
                            ...
                            <?php if($_SESSION && $_SESSION['id']){
                                ...
                                ?>
                                <a  class="btn btn-outline-primary btn-sm addtocart" href="mens.php?product_id=<?= $product['id'] ?>">Add To Cart</a>
                            <?php }else{ ?>
