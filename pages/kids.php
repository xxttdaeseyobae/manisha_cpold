...
include_once ($_SERVER['DOCUMENT_ROOT']."/hamroluga/admin/classes/kids.php");
...
if(isset($_GET['product_id'])){
    ...
    if($productUserObj->create()){
        header("Location: products.php?cart_success=true");
    }else{
                    ...
                    <div class="card" >
                        ...
                        <div class="card-footer">
                            ...
                            <?php if($_SESSION && $_SESSION['id']){
                                ...
                                ?>
                                <a  class="btn btn-outline-primary btn-sm addtocart" href="kids.php?product_id=<?= $product['id'] ?>">Add To Cart</a>
                            <?php }else{ ?>
